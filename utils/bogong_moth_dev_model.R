bogong_moth_dev_model <- function() {
    ...
    # remove adult
    dev.funs <- list(egg = egg, larva = larva, prepupa = prepupa, pupa = pupa)
    life <- c("egg", "immature", "immature", "pupa") # possibly write script to search for adult and egg/pupa and assume all else immature.
    return(list(
