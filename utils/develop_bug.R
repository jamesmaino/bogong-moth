develop_bug <- function(Tmax, Tmin, startDay, startStage, insect, gens = 1) {
  # arguments:
  ...
  # browser()
  ncell <- function(x) length(x) # quick mod from original darabug code
  # some checks
